  ...
  <%
       ...
       for(int index = 0; index < Param.allgametable.length; index ++){
    	   ...
    	   WritableWorkbook sheetbook =  Workbook.createWorkbook(new File(  
                   "/Users/guoyouchao/Desktop/work/client/res/Data_excel/"+tableName+".csv")); 
          ...
          if (exportdata != null){
              ...
              for(int tableIndex = 0;tableIndex < array.length(); tableIndex ++){
            	 for(int tableIndex1 = 0;tableIndex1 < array1.length(); tableIndex1 ++){
            		 System.out.print("tableIndex = "+tableIndex+"\n");
            	    JSONObject obj1 = array.getJSONObject(tableIndex);
            	    
            	    String aa = "";
            	    if (obj1.has(array1.get(tableIndex1).toString()) && obj1.isNull(array1.get(tableIndex1).toString()) == false){
            	    	aa =  obj1.getString(array1.get(tableIndex1).toString());
            	    }
            	   
               	    Label label1 = new Label(tableIndex1, tableIndex + 1,  aa); 
                    firstSheet.addCell(label1);  
                 }
