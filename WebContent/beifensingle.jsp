...
<body>
  <%      
    	   ...
    	   WritableWorkbook sheetbook =  Workbook.createWorkbook(new File(  
                   "/Users/guoyouchao/Desktop/work/datares/"+tableName+".csv")); 
    	   String exportsql = "select * from "+tableName; 
          if (tableName.equals("work") == true){
        	  exportsql = "select * from "+tableName + "";   
          }else if(tableName.equals("needdatas") == true){
        	  String dtype =  request.getParameter("type");
        	  if (dtype.equals("s") == true){
        		  sheetbook =  Workbook.createWorkbook(new File(  
                          "Users/guoyouchao/Desktop/work/datares/"+tableName+".csv"));
        		  exportsql = "select * from "+tableName;   
        	  }else{
        		  sheetbook =  Workbook.createWorkbook(new File(  
